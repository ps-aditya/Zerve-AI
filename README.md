...
# Zerve AI × HackerEarth Challenge – Retention Analysis
...
This project was built for the **Zerve AI × HackerEarth Open Innovation Challenge**.  
It transforms raw event logs into behavioral insights and predictive models of user retention.  
Key finding: only **2.24% of users stayed beyond 30 days**.
...
3. Retained vs. Churned Workflows  
4. Retention Signal Events (Lift vs. Reach)  
5. Feature Impact Simulation  
6. Frequent Workflows  
7. Onboarding Funnel Drop‑off  
8. Retention Flywheel  
